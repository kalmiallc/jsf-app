...
@Component({
  selector       : 'jsf-lb-custom-component',
  template       : `
      <div class="jsf-lb-custom-component" [ngClass]="getLayoutEditorClass()">
...
export class LbCustomComponentComponent extends AbstractLayoutBuilderComponent {
