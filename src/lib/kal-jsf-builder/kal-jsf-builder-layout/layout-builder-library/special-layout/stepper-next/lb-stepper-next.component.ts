...
@Component({
  selector       : 'jsf-lb-stepper-next',
  template       : `
      <div class="jsf-lb-stepper-next" [ngClass]="getLayoutEditorClass()">
...
export class LbStepperNextComponent extends AbstractLayoutBuilderComponent {
