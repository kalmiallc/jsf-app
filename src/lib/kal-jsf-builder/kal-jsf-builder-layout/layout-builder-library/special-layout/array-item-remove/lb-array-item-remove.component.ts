...
@Component({
  selector       : 'jsf-lb-array-item-remove',
  template       : `
      <ng-container [ngSwitch]="themePreferences.variant">
          <button *ngSwitchCase="'basic'"
                  type="button"
                  class="jsf-lb-array-item-remove jsf-layout-array-item-remove jsf-animatable"
...
export class LbArrayItemRemoveComponent extends AbstractLayoutBuilderComponent {
