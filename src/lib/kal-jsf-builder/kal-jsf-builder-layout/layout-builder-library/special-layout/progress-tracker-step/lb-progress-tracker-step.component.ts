...
@Component({
  selector       : 'jsf-lb-progress-tracker-step',
  template       : `
      <div class="jsf-lb-progress-tracker-step" [ngClass]="getLayoutEditorClass()">
...
export class LbProgressTrackerStepComponent extends AbstractLayoutBuilderComponent {
