...
@Component({
  selector       : 'jsf-lb-expansion-panel-header',
  template       : `
      <div class="jsf-lb-expansion-panel-header" [ngClass]="getLayoutEditorClass()">
...
export class LbExpansionPanelHeaderComponent extends AbstractLayoutBuilderComponent {
