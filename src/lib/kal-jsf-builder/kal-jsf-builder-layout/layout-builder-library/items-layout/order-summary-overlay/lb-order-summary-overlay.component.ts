...
@Component({
  selector       : 'jsf-lb-order-summary-overlay',
  template       : `
      <div class="jsf-lb-order-summary-overlay" [ngClass]="getLayoutEditorClass()">
...
export class LbOrderSummaryOverlayComponent extends AbstractLayoutBuilderComponent {
