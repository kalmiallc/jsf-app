...
@Component({
  selector       : 'jsf-lb-order-summary',
  template       : `
      <div class="jsf-lb-order-summary" [ngClass]="getLayoutEditorClass()">
...
export class LbOrderSummaryComponent extends AbstractLayoutBuilderComponent {
