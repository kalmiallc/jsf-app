...
@Component({
  selector       : 'jsf-lb-drawer-content',
  template       : `
      <div class="jsf-lb-drawer-content" [ngClass]="getLayoutEditorClass()">
...
export class LbDrawerContentComponent extends AbstractLayoutBuilderComponent {
