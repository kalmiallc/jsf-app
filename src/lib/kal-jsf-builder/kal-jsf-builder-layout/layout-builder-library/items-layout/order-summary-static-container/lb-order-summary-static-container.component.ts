...
@Component({
  selector       : 'jsf-lb-order-summary-static-container',
  template       : `
      <div class="jsf-lb-order-summary-static-container" [ngClass]="getLayoutEditorClass()">
...
export class LbOrderSummaryStaticContainerComponent extends AbstractLayoutBuilderComponent {
