...
@Component({
  selector       : 'jsf-lb-expansion-panel-content',
  template       : `
      <div class="jsf-lb-expansion-panel-content" [ngClass]="getLayoutEditorClass()">
...
export class LbExpansionPanelContentComponent extends AbstractLayoutBuilderComponent {
