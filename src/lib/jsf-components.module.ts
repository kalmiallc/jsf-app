...
import { LayoutIframeComponent }                      from './kal-jsf-doc/layout-library/special-layout/iframe/iframe.component';
...
import { LayoutExpansionPanelStandaloneComponent }    from './kal-jsf-doc/layout-library/items-layout/expansion-panel-standalone/expansion-panel-standalone.component';
import { LayoutWizardStepperContentComponent }        from './kal-jsf-doc/layout-library/items-layout/wizard-stepper-content/wizard-stepper-content.component';
import { LayoutRender3DComponent }                    from './kal-jsf-doc/layout-library/special-layout/render-3d/render-3d.component';
...
@NgModule({
  ...
  declarations: [
    ...
    LayoutExpansionPanelStandaloneComponent,
    LayoutWizardComponent,
    LayoutWizardStepperHeaderComponent,
    LayoutWizardStepperContentComponent
  ],
  exports     : [
    // Scrollbar module
