...
@Component({
  ...
  template       : `
      ...
      <div class="jsf-layout-menu jsf-animatable d-inline-block"
          ...
          <mat-menu #rootMenu="matMenu">
              <ng-container *ngFor="let item of items">
                  <ng-container *ngIf="item.layout.type === 'menu-item'; else layoutItem">
                      <jsf-layout-menu-item [layoutBuilder]="item"
...
export class LayoutMenuComponent extends AbstractItemsLayoutComponent<JsfLayoutMenu> implements OnInit {
  ...
  rootMenuTrigger: MatMenuTrigger;
  ...
  get items(): JsfUnknownLayoutBuilder[] {
