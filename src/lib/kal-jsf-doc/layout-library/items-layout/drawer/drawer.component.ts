...
@Component({
  ...
  template       : `
      <div class="jsf-layout-drawer jsf-animatable"
...
export class LayoutDrawerComponent extends AbstractItemsLayoutComponent<JsfLayoutDrawer> implements OnInit, AfterViewInit, OnDestroy {
  ...
  @ViewChild('drawerContentWrapper', { static: true })
