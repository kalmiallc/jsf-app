...
@Component({
  ...
  template       : `
      <ng-container [ngSwitch]="level">
          <h1 *ngSwitchCase="1" class="jsf-layout-heading jsf-animatable" (click)="handleLayoutClick($event)" [ngClass]="htmlClass">{{ title }}</h1>
          <h2 *ngSwitchCase="2" class="jsf-layout-heading jsf-animatable" (click)="handleLayoutClick($event)" [ngClass]="htmlClass">{{ title }}</h2>
          <h3 *ngSwitchCase="3" class="jsf-layout-heading jsf-animatable" (click)="handleLayoutClick($event)" [ngClass]="htmlClass">{{ title }}</h3>
          <h4 *ngSwitchCase="4" class="jsf-layout-heading jsf-animatable" (click)="handleLayoutClick($event)" [ngClass]="htmlClass">{{ title }}</h4>
          <h5 *ngSwitchCase="5" class="jsf-layout-heading jsf-animatable" (click)="handleLayoutClick($event)" [ngClass]="htmlClass">{{ title }}</h5>
          <h6 *ngSwitchCase="6" class="jsf-layout-heading jsf-animatable" (click)="handleLayoutClick($event)" [ngClass]="htmlClass">{{ title }}</h6>
