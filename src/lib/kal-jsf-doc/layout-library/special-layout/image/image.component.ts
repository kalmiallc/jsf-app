...
@Component({
  ...
  template       : `
      <ng-container *ngIf="!displayAsBackgroundImage">
          <img class="jsf-layout-image jsf-animatable jsf-layout-image-display-mode-image"
               [ngClass]="htmlClass"
               *ngIf="image"
               [src]="image"
      ...
      <ng-container *ngIf="displayAsBackgroundImage">
          <div class="jsf-layout-image jsf-animatable jsf-layout-image-display-mode-background"
               [ngClass]="htmlClass"
               *ngIf="image"
               (click)="handleLayoutClick($event)"
               [style.width]="width || ''"
