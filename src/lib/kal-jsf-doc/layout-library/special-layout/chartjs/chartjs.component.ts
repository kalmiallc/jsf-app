...
export const chartjsConfig = {
  ...
  libraryUrl: './assets/lib/Chart.bundle.min.js',

  pluginUrls: [
    './assets/lib/chartjs-plugin-deferred.min.js',
    './assets/lib/chartjs-plugin-style.min.js'
  ]
};
...
@Component({
  ...
  template       : `
      <div class="jsf-layout-chartjs jsf-animatable" [ngClass]="htmlClass"
