...
@Component({
  ...
  template       : `
      <div class="jsf-prop jsf-prop-array jsf-animatable" (click)="handleLayoutClick($event)" [ngClass]="htmlClass">
          <ng-container *ngFor="let itemLayouts of items; let i = index; trackBy: trackByFn">
              <jsf-prop-array-item [layoutBuilder]="layoutBuilder"
                                   [developerTools]="developerTools"
                                   [index]="i"
                                   [itemLayouts]="itemLayouts"
                                   [ngClass]="htmlArrayItemClass"
...
export class PropArrayComponent extends AbstractPropLayoutComponent<JsfPropBuilderArray> implements OnInit {
  ...
  get htmlArrayItemClass() {
    return (this.layout as any).htmlArrayItemClass || '';
  }
  ...
  trackByFn(index, item: JsfAbstractLayoutBuilder<JsfUnknownLayout>[]) {
...
@Component({
  ...
  template       : `
      <jsf-layout-router *ngFor="let itemLayout of itemLayouts; let i = index; trackBy: trackByFn"
